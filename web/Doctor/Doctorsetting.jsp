        ...
        <div class="pusher">
            <div class="ui grid">
                ...
                <div class="twelve wide column"> 
                    ...
                    <form class="ui form" method="post" action="/Hospital/MainBackEnd?action=updateDoctor">
                        ...
                        <div class="fields">
                            <div class="seven wide field">
                                ...
                                <input type="email" name="doctoremail" maxlength="16" placeholder="abc@gmail.com" required="">
                            </div>
                                <!--
                            <div class="seven wide field">
