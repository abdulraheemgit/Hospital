                    ...
                    <nav class="navbar navbar-default" role="navigation">
                        ...
                        <div class="collapse navbar-collapse" id="navbar-collapse-01">
                            <ul class="nav navbar-nav">           
                                <li class="active"><a href="/Hospital/MainBackEnd?action=doctordash"><i class="dashboard icon"></i> Dashboard</a></li>
                                <li><a href="/Hospital/MainBackEnd?action=mdeilist"><i class="user icon"></i> Patients List</a></li>
                            </ul>          
