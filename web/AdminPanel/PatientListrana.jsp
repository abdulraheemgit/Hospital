                    ...
                    <table class="ui celled table">
                        <thead>
                            <tr>
                                ...
                                <th class='center aligned'>Date Admitted</th> 
                        ...
                        <c:choose>
                            ...
                            <tr>
                                <td class="center aligned"><h2>No Medications Found</h2></td>
                            </tr>
                            </c:when>
                            <c:otherwise>
                                <c:forEach var="medicine" items="${listMedications}">
                                    <tr id="${medicine.madicationId}">
                                        ...
                                        <td class="center aligned patientId"><c:out value="${medicine.patientName}"/></td>
            ...
            if (responseJson != null || responseJson != "") {
                ...
                $.each(responseJson, function(index, item) { // Iterate over the JSON array.
                    $("tbody").append("<tr><td class='center aligned'>" + item.madicationId + "</td>\n\
                                        ...
                                        <td class='center aligned'>" + item.patientName + "</td>\n\
