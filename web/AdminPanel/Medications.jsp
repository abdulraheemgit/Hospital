            ...
            <div class="ui grid">
                ...
                <div class="twelve wide column"> 
                    ...
                    <table class="ui celled table">
                        <thead>
                            <tr>
                                <th class='center aligned'>Medication ID</th>
                                <th class='center aligned'>Patient ID</th>
                                <th class='center aligned'>Doctor ID</th>
                                <th class='center aligned'>Date Given</th>
                        ...
                        <c:choose>
                            <c:when test="${empty listMedications}">
                                <tr>
                                    <td class="center aligned"><h2>No New Medications Found</h2></td>
                                </tr>
                            </c:when>
                            <c:otherwise>
                ...
                <a class="btn btn-info" href="javascript:eToggle('atag','helptxt');" id="atag">Show History</a>
                ...
                <div id="helptxt" style="display: none">
                    <table class="ui celled table">
                        ...
                        <tbody>
                            <c:choose>
                                <c:when test="${empty listMedications1}">
                                    <tr>
                                        <td class="center aligned"><h2>No Old Medications Found</h2></td>
                                    </tr>
                                </c:when>
                                <c:otherwise>
                                    <c:forEach var="medicine1" items="${listMedications1}">
                                    <td class="center aligned meddicationId"><c:out value="${medicine1.madicationId}"/></td>
                                    <td class="center aligned patientId"><c:out value="${medicine1.patientId}"/></td>
                                    <td class="center aligned "><c:out value="${medicine1.doctorId}"/></td>
                                    <td class="center aligned "><c:out value="${medicine1.dateGiven}"/></td>
                                    <td class="center aligned "><c:out value="${medicine1.issuedDate}"/></td>
                                    <td class="center aligned "><c:out value="${medicine1.status}"/></td>
                                    </tr>
                                </c:forEach>
                            </c:otherwise>
                        </c:choose>
...
function eToggle(anctag,darg) 
{
  ...
  if(ele.style.display == "block") 
  {
	...
	text.innerHTML = "Show Hestory";
  }
  else 
  {
	ele.style.display = "block";
	text.innerHTML = "Hide Hestory";
  }
} 
</script>
